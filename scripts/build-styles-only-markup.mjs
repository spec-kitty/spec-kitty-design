...
function render(name) {
  ...
  // citation for every styles-only component EXCEPT form-field: #141 recorded form-field's own,
  // different reason (its element path is sk-form-input/sk-form-textarea, not that it styles a
  // native element) and does not cover the other five. Asserting "#141" for all of them was
  // pass-2's own finding — five citations of an issue that owns only one component.
  const adrNote =
    name === 'form-field'
