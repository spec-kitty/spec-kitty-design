...
const LINE_ITEMS = [
  ...
  { item: 6, file: 'apps/storybook/src/tests/sk-team-overview-shell-layout.spec.ts', line: 109, label: 'exact 56/240px columns' },
  { item: 7, file: 'apps/storybook/src/tests/sk-team-overview-shell-layout.spec.ts', line: 165, label: 'narrow shell region order' },
  { item: 8, file: 'apps/storybook/src/tests/sk-team-overview-shell-layout.spec.ts', line: 308, label: 'landmarks/labels/grouping' },
  { item: 9, file: 'apps/storybook/src/tests/sk-team-overview-shell-layout.spec.ts', line: 450, label: 'axe-clean in dark mode' },
