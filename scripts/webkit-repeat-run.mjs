...
const LINE_ITEMS = [
  ...
  { item: 4, file: 'apps/storybook/src/tests/sk-progress.spec.ts', line: 525, label: 'reduced-motion freeze' },
  { item: 5, file: 'apps/storybook/src/tests/sk-progress.spec.ts', line: 570, label: 'no animation leak onto determinate' },
