...
Components in these artifacts: sk-card, sk-form-input, sk-form-textarea, sk-grid, sk-nav-pill, sk-stub.

| artifact | raw | minified | min+gzip | notes |
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 56.3 KiB | 40.4 KiB | 10 KiB | `lit` external |
| `IIFE (dist/elements.js)` | 77.7 KiB | 54.3 KiB | 15 KiB | runtime bundled |
...
- ADR-8's ~6 KB is **minified+gzip**, and the IIFE now measures 15.5 KiB
  ...
  carries 6 component(s) (sk-card, sk-form-input, sk-form-textarea, sk-grid, sk-nav-pill, sk-stub), which is why the figure
...
fixed cost (21.4 KiB of the IIFE is Lit, since the
...
77.7 KiB here and "24.0 KB" in the WP prompt. Same 79515
bytes.
...
packages/elements/dist/index.js
  raw         57600 bytes  (56.3 KiB)
  minified    41345 bytes  (40.4 KiB)
  gzip         14 KiB
  min+gzip     10 KiB
packages/elements/dist/elements.js
  raw         79515 bytes  (77.7 KiB)
  minified    55634 bytes  (54.3 KiB)
  gzip         20 KiB
  min+gzip     15 KiB
```
