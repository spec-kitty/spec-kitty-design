...
Components in these artifacts: sk-action-row, sk-app-shell, sk-bar-chart, sk-blog-card, sk-button, sk-card, sk-check-bullet, sk-context-sidebar, sk-copy-field, sk-entity-marker, sk-evidence-chain, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-metric, sk-nav-pill, sk-notice, sk-page-header, sk-personal-rail, sk-pill-tag, sk-ribbon-card, sk-section-banner, sk-section-header, sk-site-footer, sk-status-indicator, sk-stub, sk-time-series-chart, sk-transition-matrix.

| artifact | raw | minified | min+gzip | notes |
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 214.3 KiB | 143.8 KiB | 30 KiB | `lit` external |
| `IIFE (dist/elements.js)` | 231.7 KiB | 153.2 KiB | 34 KiB | runtime bundled |
...
```
integrity="sha384-reMcNaAVpwVB0ZALaxCLYkxlyEDbRW26Ube9FDEg2MGoZiX5XYzLx1CAgTorFdm7"
```
...
| `@spec-kitty/styles` | 230 | 584.6 KiB |
| `@spec-kitty/elements` | 50 | 859.7 KiB |
| `@spec-kitty/react` | 62 | 156.4 KiB |
...
- ADR-8's ~6 KB is **minified+gzip**, and the IIFE now measures 33.8 KiB
  ...
  carries 29 component(s) (sk-action-row, sk-app-shell, sk-bar-chart, sk-blog-card, sk-button, sk-card, sk-check-bullet, sk-context-sidebar, sk-copy-field, sk-entity-marker, sk-evidence-chain, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-metric, sk-nav-pill, sk-notice, sk-page-header, sk-personal-rail, sk-pill-tag, sk-ribbon-card, sk-section-banner, sk-section-header, sk-site-footer, sk-status-indicator, sk-stub, sk-time-series-chart, sk-transition-matrix), which is why the figure
...
runtime cost MEASURED AT THIS BUILD (17.4 KiB of the IIFE is Lit, since the
...
grew it asserted that 237255 bytes are "24.0 KB" — false by a factor of
...
packages/elements/dist/index.js
  raw        219467 bytes  (214.3 KiB)
  minified   147298 bytes  (143.8 KiB)
  gzip         45 KiB
  min+gzip     30 KiB
packages/elements/dist/elements.js
  raw        237255 bytes  (231.7 KiB)
  minified   156891 bytes  (153.2 KiB)
  gzip         50 KiB
  min+gzip     34 KiB
```
