...
Components in these artifacts: sk-action-row, sk-app-shell, sk-bar-chart, sk-blog-card, sk-button, sk-card, sk-check-bullet, sk-context-sidebar, sk-entity-marker, sk-evidence-chain, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-metric, sk-nav-pill, sk-notice, sk-page-header, sk-personal-rail, sk-pill-tag, sk-ribbon-card, sk-section-banner, sk-section-header, sk-site-footer, sk-status-indicator, sk-stub, sk-transition-matrix.

| artifact | raw | minified | min+gzip | notes |
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 159.4 KiB | 107.4 KiB | 22 KiB | `lit` external |
| `IIFE (dist/elements.js)` | 176.2 KiB | 117.3 KiB | 26 KiB | runtime bundled |
...
```
integrity="sha384-BTFy6LFWdjzCEtZ3b2rTCWs/pM81hBlbc38GEGGDUtr9mz6ARzeYPsIWEGTVgPgO"
```
...
|---|---:|---:|
| `@spec-kitty/tokens` | 37 | 5758.7 KiB |
| `@spec-kitty/styles` | 121 | 253.3 KiB |
| `@spec-kitty/elements` | 47 | 676.4 KiB |
| `@spec-kitty/react` | 58 | 137.2 KiB |
...
- ADR-8's ~6 KB is **minified+gzip**, and the IIFE now measures 26.0 KiB
  ...
  carries 27 component(s) (sk-action-row, sk-app-shell, sk-bar-chart, sk-blog-card, sk-button, sk-card, sk-check-bullet, sk-context-sidebar, sk-entity-marker, sk-evidence-chain, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-metric, sk-nav-pill, sk-notice, sk-page-header, sk-personal-rail, sk-pill-tag, sk-ribbon-card, sk-section-banner, sk-section-header, sk-site-footer, sk-status-indicator, sk-stub, sk-transition-matrix), which is why the figure
...
runtime cost MEASURED AT THIS BUILD (16.7 KiB of the IIFE is Lit, since the
...
grew it asserted that 180380 bytes are "24.0 KB" — false by a factor of
...
packages/elements/dist/index.js
  raw        163249 bytes  (159.4 KiB)
  minified   110015 bytes  (107.4 KiB)
  gzip         33 KiB
  min+gzip     22 KiB
packages/elements/dist/elements.js
  raw        180380 bytes  (176.2 KiB)
  minified   120075 bytes  (117.3 KiB)
  gzip         39 KiB
  min+gzip     26 KiB
```
