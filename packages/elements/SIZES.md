...
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 227.8 KiB | 153.6 KiB | 32 KiB | `lit` external |
| `IIFE (dist/elements.js)` | 247.9 KiB | 164.6 KiB | 36 KiB | runtime bundled |
...
```
integrity="sha384-oJFpBZKpqnoPMCfV2ZYqenaax3J4Z9xNRGpiOwaSA4KsaNE83ynKhgRBKmGa1/gD"
```
...
| `@spec-kitty/styles` | 252 | 702.7 KiB |
| `@spec-kitty/elements` | 52 | 944.4 KiB |
...
grew it asserted that 253827 bytes are "24.0 KB" — false by a factor of
...
packages/elements/dist/index.js
  raw        233217 bytes  (227.8 KiB)
  minified   157322 bytes  (153.6 KiB)
  gzip         48 KiB
  min+gzip     32 KiB
packages/elements/dist/elements.js
  raw        253827 bytes  (247.9 KiB)
  minified   168540 bytes  (164.6 KiB)
  gzip         54 KiB
  min+gzip     36 KiB
```
