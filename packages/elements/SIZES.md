...
Components in these artifacts: sk-button, sk-card, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-nav-pill, sk-ribbon-card, sk-section-banner, sk-stub.

| artifact | raw | minified | min+gzip | notes |
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 85.4 KiB | 64.0 KiB | 16 KiB | `lit` external |
| `IIFE (dist/elements.js)` | 103.9 KiB | 75.9 KiB | 21 KiB | runtime bundled |
...
- ADR-8's ~6 KB is **minified+gzip**, and the IIFE now measures 20.6 KiB
  ...
  carries 10 component(s) (sk-button, sk-card, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-nav-pill, sk-ribbon-card, sk-section-banner, sk-stub), which is why the figure
...
fixed cost (18.5 KiB of the IIFE is Lit, since the
...
103.9 KiB here and "24.0 KB" in the WP prompt. Same 106408
bytes.
...
packages/elements/dist/index.js
  raw         87492 bytes  (85.4 KiB)
  minified    65523 bytes  (64.0 KiB)
  gzip         20 KiB
  min+gzip     16 KiB
packages/elements/dist/elements.js
  raw        106408 bytes  (103.9 KiB)
  minified    77698 bytes  (75.9 KiB)
  gzip         26 KiB
  min+gzip     21 KiB
```
