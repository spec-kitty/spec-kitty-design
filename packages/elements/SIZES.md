...
Components in these artifacts: sk-button, sk-card, sk-check-bullet, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-nav-pill, sk-pill-tag, sk-ribbon-card, sk-section-banner, sk-stub.

| artifact | raw | minified | min+gzip | notes |
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 92.5 KiB | 69.1 KiB | 17 KiB | `lit` external |
| `IIFE (dist/elements.js)` | 109.9 KiB | 80.3 KiB | 22 KiB | runtime bundled |
...
- ADR-8's ~6 KB is **minified+gzip**, and the IIFE now measures 21.6 KiB
  ...
  carries 12 component(s) (sk-button, sk-card, sk-check-bullet, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-nav-pill, sk-pill-tag, sk-ribbon-card, sk-section-banner, sk-stub), which is why the figure
...
fixed cost (17.4 KiB of the IIFE is Lit, since the
...
109.9 KiB here and "24.0 KB" in the WP prompt. Same 112496
bytes.
...
packages/elements/dist/index.js
  raw         94688 bytes  (92.5 KiB)
  minified    70803 bytes  (69.1 KiB)
  gzip         22 KiB
  min+gzip     17 KiB
packages/elements/dist/elements.js
  raw        112496 bytes  (109.9 KiB)
  minified    82220 bytes  (80.3 KiB)
  gzip         27 KiB
  min+gzip     22 KiB
```
