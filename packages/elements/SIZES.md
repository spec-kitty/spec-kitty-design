...
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 151.0 KiB | 101.0 KiB | 21 KiB | `lit` external |
...
```
integrity="sha384-2PX4IQ21z5PN/Dd8JE9/VDWleae7raDmK+/ZyqpH43D8usSUL0UMTOj1+ihDErYq"
```
...
| `@spec-kitty/styles` | 120 | 251.9 KiB |
| `@spec-kitty/elements` | 46 | 648.1 KiB |
...
grew it asserted that 171856 bytes are "24.0 KB" — false by a factor of
...
packages/elements/dist/index.js
  raw        154630 bytes  (151.0 KiB)
  minified   103408 bytes  (101.0 KiB)
  gzip         32 KiB
  min+gzip     21 KiB
packages/elements/dist/elements.js
  raw        171856 bytes  (167.8 KiB)
  minified   113572 bytes  (110.9 KiB)
  gzip         37 KiB
  min+gzip     25 KiB
```
