...
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 105.4 KiB | 70.3 KiB | 15 KiB | `lit` external |
| `IIFE (dist/elements.js)` | 118.9 KiB | 78.6 KiB | 18 KiB | runtime bundled |
...
```
integrity="sha384-Twf+Gp/VMgCANblOfwQmZ1yCmmdopXH+hF0lF/ei0sNt4pXo1aKhsZ/ZtAtllSXY"
```
...
| `@spec-kitty/elements` | 38 | 464.0 KiB |
| `@spec-kitty/react` | 42 | 87.5 KiB |
...
- ADR-8's ~6 KB is **minified+gzip**, and the IIFE now measures 18.0 KiB
...
runtime cost MEASURED AT THIS BUILD (13.5 KiB of the IIFE is Lit, since the
...
grew it asserted that 121716 bytes are "24.0 KB" — false by a factor of
...
packages/elements/dist/elements.js
  raw        121716 bytes  (118.9 KiB)
  minified    80489 bytes  (78.6 KiB)
  gzip         26 KiB
  min+gzip     18 KiB
```
