...
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 159.5 KiB | 107.6 KiB | 22 KiB | `lit` external |
| `IIFE (dist/elements.js)` | 176.2 KiB | 117.4 KiB | 26 KiB | runtime bundled |
...
```
integrity="sha384-ovi1MGom3MCkJ3XI66VtY9M//4+8S/KaqPWepuurRsGwnVqC9uDVx2ZtTEb3fXpJ"
```
...
| `@spec-kitty/elements` | 46 | 675.0 KiB |
...
grew it asserted that 180457 bytes are "24.0 KB" — false by a factor of
...
packages/elements/dist/index.js
  raw        163318 bytes  (159.5 KiB)
  minified   110147 bytes  (107.6 KiB)
  gzip         33 KiB
  min+gzip     22 KiB
packages/elements/dist/elements.js
  raw        180457 bytes  (176.2 KiB)
  minified   120206 bytes  (117.4 KiB)
  gzip         39 KiB
  min+gzip     26 KiB
```
