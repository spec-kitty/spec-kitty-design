...
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 150.9 KiB | 100.9 KiB | 21 KiB | `lit` external |
| `IIFE (dist/elements.js)` | 167.8 KiB | 110.9 KiB | 25 KiB | runtime bundled |
...
```
integrity="sha384-j+FeMo2I41KHu4g17Dv2REEpVDneT7ScpJGDmbp3wJVSS4BjxsYBqIy0qoxy7kI1"
```
...
| `@spec-kitty/elements` | 46 | 648.0 KiB |
...
grew it asserted that 171797 bytes are "24.0 KB" — false by a factor of
...
packages/elements/dist/index.js
  raw        154571 bytes  (150.9 KiB)
  minified   103353 bytes  (100.9 KiB)
  gzip         32 KiB
  min+gzip     21 KiB
packages/elements/dist/elements.js
  raw        171797 bytes  (167.8 KiB)
  minified   113517 bytes  (110.9 KiB)
  gzip         37 KiB
  min+gzip     25 KiB
```
