...
Components in these artifacts: sk-card, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-nav-pill, sk-section-banner, sk-stub.

| artifact | raw | minified | min+gzip | notes |
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 68.9 KiB | 50.3 KiB | 13 KiB | `lit` external |
| `IIFE (dist/elements.js)` | 88.8 KiB | 63.2 KiB | 18 KiB | runtime bundled |
...
- ADR-8's ~6 KB is **minified+gzip**, and the IIFE now measures 17.9 KiB
  ...
  carries 8 component(s) (sk-card, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-nav-pill, sk-section-banner, sk-stub), which is why the figure
...
fixed cost (19.9 KiB of the IIFE is Lit, since the
...
88.8 KiB here and "24.0 KB" in the WP prompt. Same 90938
bytes.
...
packages/elements/dist/index.js
  raw         70539 bytes  (68.9 KiB)
  minified    51484 bytes  (50.3 KiB)
  gzip         17 KiB
  min+gzip     13 KiB
packages/elements/dist/elements.js
  raw         90938 bytes  (88.8 KiB)
  minified    64723 bytes  (63.2 KiB)
  gzip         23 KiB
  min+gzip     18 KiB
```
