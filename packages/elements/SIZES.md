...
```
integrity="sha384-3WJ03rTJKQKQc9mbweExwXB9YNXn2nLQyck/CYjRXFc9SEc0x32jYZyANAqTuOjk"
```
...
| `@spec-kitty/styles` | 289 | 841.7 KiB |
| `@spec-kitty/elements` | 57 | 1018.7 KiB |
...
grew it asserted that 274885 bytes are "24.0 KB" — false by a factor of
...
packages/elements/dist/elements.js
  raw        274885 bytes  (268.4 KiB)
  minified   179874 bytes  (175.7 KiB)
  gzip         58 KiB
  min+gzip     39 KiB
```
