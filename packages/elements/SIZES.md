...
Components in these artifacts: sk-action-row, sk-app-shell, sk-bar-chart, sk-blog-card, sk-button, sk-card, sk-check-bullet, sk-confirm-dialog, sk-context-sidebar, sk-copy-field, sk-entity-marker, sk-evidence-chain, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-metric, sk-nav-pill, sk-notice, sk-page-header, sk-personal-rail, sk-pill-tag, sk-ribbon-card, sk-section-banner, sk-section-header, sk-site-footer, sk-status-indicator, sk-stub, sk-theme-toggle, sk-time-series-chart, sk-transition-matrix.

| artifact | raw | minified | min+gzip | notes |
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 248.6 KiB | 165.0 KiB | 35 KiB | `lit` external |
| `IIFE (dist/elements.js)` | 267.2 KiB | 174.7 KiB | 39 KiB | runtime bundled |
...
```
integrity="sha384-u4plUcj8UdQOzDMZMqnJ+GPUQIwecq5t3PZUrxnjRMuVp9yaw3+t51517iQijZV2"
```
...
|---|---:|---:|
| `@spec-kitty/tokens` | 37 | 5774.7 KiB |
| `@spec-kitty/styles` | 269 | 785.4 KiB |
| `@spec-kitty/elements` | 58 | 1016.0 KiB |
| `@spec-kitty/react` | 66 | 176.4 KiB |
...
- ADR-8's ~6 KB is **minified+gzip**, and the IIFE now measures 39 KiB
  ...
  carries 31 component(s) (sk-action-row, sk-app-shell, sk-bar-chart, sk-blog-card, sk-button, sk-card, sk-check-bullet, sk-confirm-dialog, sk-context-sidebar, sk-copy-field, sk-entity-marker, sk-evidence-chain, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-metric, sk-nav-pill, sk-notice, sk-page-header, sk-personal-rail, sk-pill-tag, sk-ribbon-card, sk-section-banner, sk-section-header, sk-site-footer, sk-status-indicator, sk-stub, sk-theme-toggle, sk-time-series-chart, sk-transition-matrix), which is why the figure
...
runtime cost MEASURED AT THIS BUILD (18.6 KiB of the IIFE is Lit, since the
...
grew it asserted that 273617 bytes are "24.0 KB" — false by a factor of
...
packages/elements/dist/index.js
  raw        254545 bytes  (248.6 KiB)
  minified   168992 bytes  (165.0 KiB)
  gzip         52 KiB
  min+gzip     35 KiB
packages/elements/dist/elements.js
  raw        273617 bytes  (267.2 KiB)
  minified   178849 bytes  (174.7 KiB)
  gzip         57 KiB
  min+gzip     39 KiB
```
