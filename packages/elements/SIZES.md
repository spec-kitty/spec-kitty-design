...
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 67.9 KiB | 41.9 KiB | 9 KiB | `lit` external |
...
- ADR-8's ~6 KB is **minified+gzip**, and the IIFE now measures 12.6 KiB
...
runtime cost MEASURED AT THIS BUILD (15.6 KiB of the IIFE is Lit, since the
...
grew it asserted that 85535 bytes are "24.0 KB" — false by a factor of
...
packages/elements/dist/index.js
  raw         69538 bytes  (67.9 KiB)
  minified    42911 bytes  (41.9 KiB)
  gzip         15 KiB
  min+gzip      9 KiB
packages/elements/dist/elements.js
  raw         85535 bytes  (83.5 KiB)
  minified    52841 bytes  (51.6 KiB)
  gzip         19 KiB
  min+gzip     13 KiB
```
