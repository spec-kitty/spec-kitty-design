...
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 225.1 KiB | 151.6 KiB | 32 KiB | `lit` external |
| `IIFE (dist/elements.js)` | 245.2 KiB | 162.6 KiB | 36 KiB | runtime bundled |
...
```
integrity="sha384-MdAAwTokvz5K0QzCn5WQdk3h5LSw/gXj9LfC86ns70u/Pd1m+NUMszQsnzsX31nY"
```
...
| `@spec-kitty/styles` | 231 | 616.7 KiB |
| `@spec-kitty/elements` | 51 | 920.6 KiB |
| `@spec-kitty/react` | 64 | 169.4 KiB |
...
- ADR-8's ~6 KB is **minified+gzip**, and the IIFE now measures 36.1 KiB
  ...
  carries 30 component(s) (sk-action-row, sk-app-shell, sk-bar-chart, sk-blog-card, sk-button, sk-card, sk-check-bullet, sk-confirm-dialog, sk-context-sidebar, sk-copy-field, sk-entity-marker, sk-evidence-chain, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-metric, sk-nav-pill, sk-notice, sk-page-header, sk-personal-rail, sk-pill-tag, sk-ribbon-card, sk-section-banner, sk-section-header, sk-site-footer, sk-status-indicator, sk-stub, sk-time-series-chart, sk-transition-matrix), which is why the figure
...
grew it asserted that 251128 bytes are "24.0 KB" — false by a factor of
...
packages/elements/dist/index.js
  raw        230469 bytes  (225.1 KiB)
  minified   155233 bytes  (151.6 KiB)
  gzip         47 KiB
  min+gzip     32 KiB
packages/elements/dist/elements.js
  raw        251128 bytes  (245.2 KiB)
  minified   166506 bytes  (162.6 KiB)
  gzip         53 KiB
  min+gzip     36 KiB
```
