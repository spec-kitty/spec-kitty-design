...
| `IIFE (dist/elements.js)` | 119.1 KiB | 78.6 KiB | 18 KiB | runtime bundled |
...
```
integrity="sha384-kjV7+Lt3c+Z83jAvbv/UQ2jqalzMie13IavwHAdUhT1EA9XQlrlBNmG2YPV00rsI"
```
...
| `@spec-kitty/styles` | 72 | 139.2 KiB |
| `@spec-kitty/elements` | 38 | 464.1 KiB |
...
runtime cost MEASURED AT THIS BUILD (13.7 KiB of the IIFE is Lit, since the
...
grew it asserted that 121956 bytes are "24.0 KB" — false by a factor of
