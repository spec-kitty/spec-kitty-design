...
Components in these artifacts: sk-action-row, sk-app-shell, sk-blog-card, sk-button, sk-card, sk-check-bullet, sk-context-sidebar, sk-entity-marker, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-nav-pill, sk-page-header, sk-personal-rail, sk-pill-tag, sk-ribbon-card, sk-section-banner, sk-section-header, sk-site-footer, sk-status-indicator, sk-stub, sk-transition-matrix.

| artifact | raw | minified | min+gzip | notes |
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 132.8 KiB | 88.1 KiB | 18 KiB | `lit` external |
| `IIFE (dist/elements.js)` | 145.8 KiB | 95.9 KiB | 21 KiB | runtime bundled |
...
```
integrity="sha384-LeB+PikF6ert/b5/BHalmfR7xnjU9yqFdJJ40atRZtQrkdpIaZKiQlP90nJWjTwN"
```
...
| `@spec-kitty/styles` | 106 | 218.5 KiB |
| `@spec-kitty/elements` | 42 | 570.6 KiB |
...
- ADR-8's ~6 KB is **minified+gzip**, and the IIFE now measures 21.3 KiB
  ...
  carries 23 component(s) (sk-action-row, sk-app-shell, sk-blog-card, sk-button, sk-card, sk-check-bullet, sk-context-sidebar, sk-entity-marker, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-nav-pill, sk-page-header, sk-personal-rail, sk-pill-tag, sk-ribbon-card, sk-section-banner, sk-section-header, sk-site-footer, sk-status-indicator, sk-stub, sk-transition-matrix), which is why the figure
...
runtime cost MEASURED AT THIS BUILD (13.0 KiB of the IIFE is Lit, since the
...
grew it asserted that 149304 bytes are "24.0 KB" — false by a factor of
...
packages/elements/dist/index.js
  raw        136037 bytes  (132.8 KiB)
  minified    90262 bytes  (88.1 KiB)
  gzip         28 KiB
  min+gzip     18 KiB
packages/elements/dist/elements.js
  raw        149304 bytes  (145.8 KiB)
  minified    98232 bytes  (95.9 KiB)
  gzip         32 KiB
  min+gzip     21 KiB
```
