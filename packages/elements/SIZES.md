...
Components in these artifacts: sk-button, sk-card, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-nav-pill, sk-pill-tag, sk-ribbon-card, sk-section-banner, sk-stub.

| artifact | raw | minified | min+gzip | notes |
|---|---:|---:|---:|---|
| `ESM  (dist/index.js)` | 90.3 KiB | 67.7 KiB | 17 KiB | `lit` external |
| `IIFE (dist/elements.js)` | 108.3 KiB | 79.2 KiB | 21 KiB | runtime bundled |
...
- ADR-8's ~6 KB is **minified+gzip**, and the IIFE now measures 21.3 KiB
  ...
  carries 11 component(s) (sk-button, sk-card, sk-feature-card, sk-form-input, sk-form-textarea, sk-grid, sk-nav-pill, sk-pill-tag, sk-ribbon-card, sk-section-banner, sk-stub), which is why the figure
...
fixed cost (18.0 KiB of the IIFE is Lit, since the
...
108.3 KiB here and "24.0 KB" in the WP prompt. Same 110854
bytes.
...
packages/elements/dist/index.js
  raw         92460 bytes  (90.3 KiB)
  minified    69290 bytes  (67.7 KiB)
  gzip         21 KiB
  min+gzip     17 KiB
packages/elements/dist/elements.js
  raw        110854 bytes  (108.3 KiB)
  minified    81104 bytes  (79.2 KiB)
  gzip         26 KiB
  min+gzip     21 KiB
```
