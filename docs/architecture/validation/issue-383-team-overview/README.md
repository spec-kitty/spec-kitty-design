...
`train/elements-first@d3263e9488f7df85a537a927d417729eacc75f12`. The refreshed code and test
surface is commit `1f4339ba`; the earlier independent approval at lane `1d1dba2e` remains in the
mission trail, and the rewritten exact head requires a fresh independent review before publication.
