...
| C-010 | One mission PR and closure | Deliver one PR with `Refs #146` from `mission/team-overview-feed-elements` into `train/elements-first`; no WP PRs or closing keyword. After the authorized train merge is verified, orchestrator wrap-up closes #146 immediately and leaves #144, #125, #112 and unfinished siblings open. | Git | High | Open |
