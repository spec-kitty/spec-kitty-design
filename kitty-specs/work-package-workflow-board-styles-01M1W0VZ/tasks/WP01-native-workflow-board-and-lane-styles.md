...
> Keep entries in chronological order (oldest first, newest last). Use the supported Spec Kitty
...
- 2026-09-06T21:55:16Z – codex – T005/T006 complete: CI run 34061369757 supplied approved Linux Chromium actuals, full WebKit/Chromium Playwright and axe green; isolated mutation harness and guard green. Nine exact CI baselines committed. T007 exact-head CI and four-lens evidence pending.
