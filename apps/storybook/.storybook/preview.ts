...
// LIGHT-DOM markup, and #177's composition story puts a `<dl class="sk-facts">` and a
// `<details class="sk-disclosure">` inside an <sk-card>'s default slot — where they stay in the
// document's cascade rather than the card's shadow root.
//
